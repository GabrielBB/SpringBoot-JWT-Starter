...
public class PCEDBHelper {
        ...
        public List<PCEVersion> getPCECatalogVersions() {
                return jdbcTemplate.query("select ID from pce1pcown.tbpc_version order by 1 desc",
                                new BeanPropertyRowMapper<PCEVersion>());
        }

        public List<Map<String, Object>> getComponentAttributes(long childId, long pceVersion) {
        ...
        public List<Map<String, Object>> getPCEComponentsByVersion(long version) {
                return jdbcTemplate.queryForList(
